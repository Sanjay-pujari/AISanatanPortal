...
export class TranslatePipe implements PipeTransform, OnDestroy {
  ...
  private initializeTranslations(): void {
    ...
    this.translations['as'] = {
      'nav.home': 'ঘৰ',
      'nav.admin': 'এডমিন পেনেল',
      'nav.evaluation': 'মূল্যায়ন',
      'nav.vedas': 'বেদ',
      'nav.puranas': 'পুৰাণ',
      'nav.kavyas': 'কাব্য',
      'nav.mathematics': 'গণিত',
      'nav.astrology': 'জ্যোতিষ',
      'nav.astronomy': 'খগোল বিজ্ঞান',
      'nav.medical': 'আয়ুৰ্বেদ',
      'nav.places': 'পবিত্ৰ স্থান',
      'nav.panchang': 'পঞ্চাং',
      'nav.bookstore': 'গ্ৰন্থাগাৰ',
      'nav.gifts': 'উপহাৰ দোকান',
      'nav.events': 'কাৰ্য্যসূচী',
      'nav.chatbot': 'AI সহায়কৰ',

      'welcome.title': "AI সনাতন প'ৰ্টেল",
      'welcome.subtitle': 'শাশ্বত জ্ঞানৰ অনুসন্ধান',
      'welcome.description': "সনাতন ধৰ্মৰ সমগ্ৰ প'ৰ্টেললৈ স্বাগতম",

      'welcome.hero.title': 'সৰ্বে ভবন্তু সুখিনঃ',
      'welcome.hero.subtitle': 'সকল জীৱ সুখী হওঁক',
      'welcome.hero.description': 'AI সনাতন প’ৰ্টেললৈ স্বাগতম — সনাতন ধৰ্মৰ শাশ্বত জ্ঞানলৈ যোৱা আপোনাৰ দ্বাৰ। বেদ-পুৰাণ অধ্যয়ন কৰক, পবিত্ৰ স্থান বিচাৰক, জ্যোতিষ আৰু খগোল বিজ্ঞান বুজক, আয়ুৰ্বেদ জানক আদি।',
      'welcome.hero.what_you_will_discover': 'আপুনি কি পোৱা যাব:',
      'welcome.hero.highlight.vedas_puranas': 'বেদ আৰু পুৰাণৰ বিস্তৃত সংগ্ৰহ',
      'welcome.hero.highlight.ai_chatbot': 'আধ্যাত্মিক পথ-প্ৰদৰ্শনৰ বাবে AI চেটবট',
      'welcome.hero.highlight.panchang': 'ইন্টাৰেক্টিভ পঞ্চাং',
      'welcome.hero.highlight.temples_directory': 'মন্দিৰ আৰু পবিত্ৰ স্থানৰ ডাইৰেক্টৰি',
      'welcome.hero.highlight.books_souvenirs': 'বিশ্বস্ত বিক্ৰেতাৰ পৰা কিতাপ আৰু স্মাৰক',
      'welcome.hero.highlight.events_gatherings': 'নিয়মিত অনুষ্ঠান আৰু আধ্যাত্মিক সমাবেশ',
      'welcome.hero.cta.explore_vedas': 'বেদ চাওক',
      'welcome.hero.cta.ai_assistant': 'AI সহায়কৰ',

      'quicklinks.vedas.title': 'বেদ',
      'quicklinks.vedas.description': 'বেদৰ শাশ্বত জ্ঞান অন্বেষণ কৰক',
      'quicklinks.puranas.title': 'পুৰাণ',
      'quicklinks.puranas.description': 'প্ৰাচীন কাহিনী আৰু জ্ঞান বিচাৰক',
      'quicklinks.panchang.title': 'পঞ্চাং',
      'quicklinks.panchang.description': 'তিথি আৰু উৎসৱৰ সৈতে হিন্দু কেলেণ্ডাৰ',
      'quicklinks.ai.title': 'AI সহায়কৰ',
      'quicklinks.ai.description': 'সনাতন ধৰ্ম সম্পৰ্কে প্ৰশ্ন কৰক',
      'quicklinks.places.title': 'পবিত্ৰ স্থান',
      'quicklinks.places.description': 'মন্দিৰ আৰু পবিত্ৰ স্থান বিচাৰক',
      'quicklinks.books.title': 'গ্ৰন্থাগাৰ',
      'quicklinks.books.description': 'আধ্যাত্মিক কিতাপ আৰু গ্ৰন্থ চাওক',

      'featured.wisdom.title': 'দৈনিক জ্ঞান',
      'featured.wisdom.content': '"ধর্মো ৰক্ষতি ৰক্ষিতঃ" - ধাৰ্মিকতা সেইসকলক ৰক্ষা কৰে, যিসকল ধাৰ্মিকতাক ৰক্ষা কৰে',
      'featured.wisdom.source': 'মহাভাৰত',
      'featured.tithi.title': 'আজিৰ তিথি',
      'featured.tithi.content': 'পঞ্চাং ডাটা ল’ড হৈ আছে...',
      'featured.tithi.source': 'হিন্দু কেলেণ্ডাৰ',
      'featured.festival.title': 'উৎসৱ সতৰ্কতা',
      'featured.festival.content': 'আসন্ন উৎসৱ আৰু আচার-অনুষ্ঠান',
      'featured.festival.source': 'কেলেণ্ডাৰ',

      'loading.message': 'ল’ড হৈ আছে...',
      'loading.quote': '"সৰ্বে ভবন্তু সুখিনঃ সৰ্বে সन्तু নিৰাময়াঃ"',
      'loading.quote.translation': 'সকল জীৱ সুখী আৰু নিৰোগ হওঁক',

      'search.placeholder': 'সন্ধান কৰক...',
      'search.button': 'সন্ধান',

      'common.read_more': 'অধিক পঢ়ক',
      'common.show_less': 'কম দেখুৱাওক',
    ...
    this.translations['te'] = {
      ...
      'nav.evaluation': 'మూల్యాంకనం',
      'nav.vedas': 'వేదాలు',
      'nav.puranas': 'పురాణాలు',
      'nav.kavyas': 'కావ్యాలు',
      'nav.mathematics': 'గణితం',
      'nav.astrology': 'జ్యోతిష్యం',
      'nav.astronomy': 'ఖగోళ శాస్త్రం',
      'nav.medical': 'ఆయుర్వేదం',
      'nav.places': 'పవిత్ర స్థలాలు',
      'nav.panchang': 'పంచాంగం',
      'nav.bookstore': 'గ్రంథాలయం',
      'nav.gifts': 'బహుమతుల దుకాణం',
      'nav.events': 'కార్యక్రమాలు',
      'nav.chatbot': 'AI సహాయకుడు',

      'welcome.title': 'AI సనాతన పోర్టల్',
      'welcome.subtitle': 'శాశ్వత జ్ఞాన అన్వేషణ',
      'welcome.description': 'సనాతన ధర్మ సమగ్ర పోర్టల్‌కు స్వాగతం',

      'welcome.hero.title': 'సర్వే భవంతు సుఖినః',
      'welcome.hero.subtitle': 'అన్ని జీవులు సంతోషంగా ఉండాలి',
      'welcome.hero.description': 'AI సనాతన పోర్టల్‌కు స్వాగతం — సనాతన ధర్మ శాశ్వత జ్ఞానానికి మీ ప్రవేశ ద్వారం. వేదాలు, పవిత్ర స్థలాలు, జ్యోతిష్యం, ఖగోళ శాస్త్రం, ఆయుర్వేదం మరియు మరెన్నో తెలుసుకోండి.',
      'welcome.hero.what_you_will_discover': 'మీరు తెలుసుకునేది:',
      'welcome.hero.highlight.vedas_puranas': 'వేదాలు, పురాణాల సమగ్ర సేకరణ',
      'welcome.hero.highlight.ai_chatbot': 'ఆధ్యాత్మిక మార్గదర్శకత్వానికి AI చాట్‌బాట్',
      'welcome.hero.highlight.panchang': 'ఇంటరాక్టివ్ పంచాంగం',
      'welcome.hero.highlight.temples_directory': 'దేవాలయాలు మరియు పవిత్ర స్థలాల డైరెక్టరీ',
      'welcome.hero.highlight.books_souvenirs': 'నమ్మదగిన విక్రేతల నుండి పుస్తకాలు మరియు స్మారకాలు',
      'welcome.hero.highlight.events_gatherings': 'నియమిత కార్యక్రమాలు మరియు ఆధ్యాత్మిక సమావేశాలు',
      'welcome.hero.cta.explore_vedas': 'వేదాలు చూడండి',
      'welcome.hero.cta.ai_assistant': 'AI సహాయకుడు',

      'quicklinks.vedas.title': 'వేదాలు',
      'quicklinks.vedas.description': 'వేదాల శాశ్వత జ్ఞానాన్ని అన్వేషించండి',
      'quicklinks.puranas.title': 'పురాణాలు',
      'quicklinks.puranas.description': 'ప్రాచీన కథలు మరియు జ్ఞానం తెలుసుకోండి',
      'quicklinks.panchang.title': 'పంచాంగం',
      'quicklinks.panchang.description': 'తిథులు, పండుగలతో హిందూ క్యాలెండర్',
      'quicklinks.ai.title': 'AI సహాయకుడు',
      'quicklinks.ai.description': 'సనాతన ధర్మంపై ప్రశ్నలు అడగండి',
      'quicklinks.places.title': 'పవిత్ర స్థలాలు',
      'quicklinks.places.description': 'దేవాలయాలు మరియు పవిత్ర స్థలాలు కనుగొనండి',
      'quicklinks.books.title': 'గ్రంథాలయం',
      'quicklinks.books.description': 'ఆధ్యాత్మిక పుస్తకాలు మరియు గ్రంథాలు బ్రౌజ్ చేయండి',

      'featured.wisdom.title': 'దైనందిన జ్ఞానం',
      'featured.wisdom.content': '"ధర్మో రక్షతి రక్షితః" - ధర్మాన్ని రక్షించేవారిని ధర్మమే రక్షిస్తుంది',
      'featured.wisdom.source': 'మహాభారతం',
      'featured.tithi.title': 'ఈరోజు తిథి',
      'featured.tithi.content': 'పంచాంగ డేటా లోడవుతోంది...',
      'featured.tithi.source': 'హిందూ క్యాలెండర్',
      'featured.festival.title': 'ఉత్సవ హెచ్చరిక',
      'featured.festival.content': 'రాబోయే ఉత్సవాలు మరియు ఆచారాలు',
      'featured.festival.source': 'క్యాలెండర్',

      'loading.message': 'లోడ్ అవుతోంది...',
      'loading.quote': '"సర్వే భవంతు సుఖినః సర్వే సంతు నిరామయాః"',
      'loading.quote.translation': 'అన్ని జీవులు సంతోషంగా, ఆరోగ్యంగా ఉండాలి',

      'search.placeholder': 'శోధించండి...',
      'search.button': 'శోధించండి',

      'common.read_more': 'ఇంకా చదవండి',
      'common.show_less': 'తక్కువ చూపించండి',
    ...
    const starting: { [lang: string]: TranslationData } = {
      ...
      'as': {
        'starting.quick_access.title': 'দ্ৰুত প্ৰবেশ',
        'starting.quick_access.subtitle': 'আপোনাৰ আধ্যাত্মিক যাত্ৰা আৰম্ভ কৰক',
        'starting.todays_inspiration': 'আজিৰ প্ৰেৰণা',
        'starting.features.title': 'সমগ্ৰ আধ্যাত্মিক মঞ্চ',
        'starting.features.subtitle': 'আপোনাৰ আধ্যাত্মিক যাত্ৰাৰ সকলোবোৰ এটা ঠাইত',
        'starting.features.items.ai_learning.title': 'AI-চালিত শিক্ষা',
        'starting.features.items.ai_learning.description': 'প্ৰামাণিক সংস্কৃত গ্ৰন্থত প্ৰশিক্ষিত আমাৰ উন্নত AI চেটবটৰ জৰিয়তে আপোনাৰ আধ্যাত্মিক প্ৰশ্নসমূহৰ ব্যক্তিগত পৰামৰ্শ আৰু উত্তৰ লাভ কৰক।',
        'starting.features.items.sacred_geography.title': 'পবিত্ৰ ভূগোল',
        'starting.features.items.sacred_geography.description': 'ইতিহাসিক গুৰুত্ব আৰু ভ্ৰমণ তথ্যসহ ইন্টাৰেক্টিভ মানচিত্ৰত হাজাৰ হাজাৰ মন্দিৰ আৰু পৌৰাণিক স্থান অনুসন্ধান কৰক।',
        'starting.features.items.panchang.title': 'পঞ্চাং কেলেণ্ডাৰ',
        'starting.features.items.panchang.description': 'তিথি, নক্ষত্র, উৎসৱ আৰু শুভ মুহূৰ্তসহ হিন্দু কেলেণ্ডাৰৰ সৈতে সংযুক্ত থাকক।',
        'starting.features.items.digital_library.title': 'ডিজিটেল গ্ৰন্থাগাৰ',
        'starting.features.items.digital_library.description': 'বেদ, পুৰাণ, উপনিষদ আৰু আধুনিক আধ্যাত্মিক গ্ৰন্থৰ বিস্তৃত সংগ্ৰহ অভিগম কৰক।',
        'starting.features.items.ayurveda.title': 'আয়ুৰ্বেদ জ্ঞান',
        'starting.features.items.ayurveda.description': 'ভেষজ চিকিৎসা, জীৱনশৈলী অভ্যাস আৰু সামগ্ৰিক চিকিৎসা পদ্ধতি আদি প্ৰাচীন চিকিৎসা জ্ঞান শিকক।',
        'starting.features.items.vedic_sciences.title': 'বৈদিক বিজ্ঞান',
        'starting.features.items.vedic_sciences.description': 'প্ৰাচীন হিন্দু গ্ৰন্থত বৰ্ণিত গণিতীয় অৱদান, খগোলীয় আৱিষ্কাৰ আৰু জ্যোতিষীয় দৃষ্টিভংগী সম্পৰ্কে শিকক।',
        'starting.cta.title': 'আপোনাৰ আধ্যাত্মিক যাত্ৰা আৰম্ভ কৰক',
        'starting.cta.subtitle': 'আমাৰ AI-চালিত শিক্ষা মঞ্চৰে সনাতন ধৰ্মৰ গভীৰ জ্ঞান আবিষ্কাৰ কৰক',
        'starting.cta.start_assessment': 'মূল্যায়ন আৰম্ভ কৰক',
        'starting.cta.ask_ai': 'AI সহায়কক সোধক',
        'stats.vedas': 'বেদ',
        'stats.puranas': 'পুৰাণ',
        'stats.sacred_places': 'পবিত্ৰ স্থান',
        'stats.books': 'বই',
        'stats.festivals': 'উৎসৱ',
        'stats.ai_support': 'AI সহায়'
      },
      'te': {
        'starting.quick_access.title': 'త్వరిత ప్రవేశం',
        'starting.quick_access.subtitle': 'మీ ఆధ్యాత్మిక ప్రయాణాన్ని ప్రారంభించండి',
        'starting.todays_inspiration': 'ఈరోజు ప్రేరణ',
        'starting.features.title': 'సమగ్ర ఆధ్యాత్మిక వేదిక',
        'starting.features.subtitle': 'మీ ఆధ్యాత్మిక ప్రయాణానికి కావలసినవన్నీ ఒకేచోట',
        'starting.features.items.ai_learning.title': 'AI ఆధారిత అభ్యాసం',
        'starting.features.items.ai_learning.description': 'ప్రామాణిక సంస్కృత గ్రంథాలపై శిక్షణ పొందిన మా పురోగతిచెందిన AI చాట్‌బాట్ ద్వారా మీ ఆధ్యాత్మిక ప్రశ్నలకు వ్యక్తిగత మార్గదర్శకత్వం మరియు సమాధానాలు పొందండి.',
        'starting.features.items.sacred_geography.title': 'పవిత్ర భూగోళం',
        'starting.features.items.sacred_geography.description': 'చారిత్రక ప్రాముఖ్యతతో పాటు ప్రయాణ సమాచారంతో ఇంటరాక్టివ్ మ్యాప్స్‌లో వేలాది దేవాలయాలు మరియు పౌరాణిక ప్రదేశాలను అన్వేషించండి.',
        'starting.features.items.panchang.title': 'పంచాంగ క్యాలెండర్',
        'starting.features.items.panchang.description': 'తిథులు, నక్షత్రాలు, పండుగలు మరియు శుభ ముహూర్తాలతో హిందూ క్యాలెండర్‌తో అనుసంధానంగా ఉండండి.',
        'starting.features.items.digital_library.title': 'డిజిటల్ గ్రంథాలయం',
        'starting.features.items.digital_library.description': 'వేదాలు, పురాణాలు, ఉపనిషత్తులు మరియు ఆధునిక ఆధ్యాత్మిక పుస్తకాల విస్తృత సేకరణను యాక్సెస్ చేయండి.',
        'starting.features.items.ayurveda.title': 'ఆయుర్వేద జ్ఞానం',
        'starting.features.items.ayurveda.description': 'ఔషధ మొక్కల చికిత్సలు, జీవనశైలి ఆచరణలు మరియు సమగ్ర చికిత్సా విధానాలు వంటి ప్రాచీన వైద్యజ్ఞానాన్ని తెలుసుకోండి.',
        'starting.features.items.vedic_sciences.title': 'వేద శాస్త్రాలు',
        'starting.features.items.vedic_sciences.description': 'ప్రాచీన హిందూ గ్రంథాల్లో వర్ణించిన గణిత సాహకారాలు, ఖగోళ ఆవిష్కరణలు మరియు జ్యోతిష్య దృక్కోణాల గురించి తెలుసుకోండి.',
        'starting.cta.title': 'మీ ఆధ్యాత్మిక ప్రయాణాన్ని ప్రారంభించండి',
        'starting.cta.subtitle': 'మా AI ఆధారిత అభ్యాస వేదికతో సనాతన ధర్మం యొక్క లోతైన జ్ఞానాన్ని తెలుసుకోండి',
        'starting.cta.start_assessment': 'మూల్యాంకనాన్ని ప్రారంభించండి',
        'starting.cta.ask_ai': 'AI సహాయకుడిని అడగండి',
        'stats.vedas': 'వేదాలు',
        'stats.puranas': 'పురాణాలు',
        'stats.sacred_places': 'పవిత్ర స్థలాలు',
        'stats.books': 'పుస్తకాలు',
        'stats.festivals': 'పండుగలు',
        'stats.ai_support': 'AI మద్దతు'
      },
      'bn': {
